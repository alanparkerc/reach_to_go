...
class KeywordsPage extends StatefulWidget {
  ...
  final List<Map<String, dynamic>> keywordsTable;
  ...
  const KeywordsPage(
      ...
      required this.keywordsTable,
      required this.dropdownChoice});

  @override
  KeywordsPageState createState() => KeywordsPageState();
}
...
class KeywordsPageState extends State<KeywordsPage> {
  ...
  void initState() {
    super.initState();
    returnObject['keywordTables'] = widget.keywordsTable;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      (returnObjectChanged &&
                                          ...
                                          : const SizedBox(),
                                      (returnObject['keywordTables'].isEmpty)
                                          ? Column(
                                              crossAxisAlignment:
                                                  CrossAxisAlignment.start,
                                              children: [
